...
# def print_then_return(list):
#     print(list[0])
#     return(list[1])

# print(print_then_return([1,2]))
...
# original list that are greater than its 2nd value. Print how many values this is and then return the new list. 
